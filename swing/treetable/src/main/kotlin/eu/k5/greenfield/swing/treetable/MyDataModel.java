...
public class MyDataModel extends MyAbstractTreeTableModel {
    // Spalten Name.
    static protected String[] columnNames = {"Knotentext", "String", "Datum", "Integer", "Checkbox"};

    // Spalten Typen.
    static protected Class<?>[] columnTypes = {MyTreeTableModel.class, String.class, Date.class, Integer.class, Boolean.class};
    ...
    public Object getValueAt(Object node, int column) {
        switch (column) {
            ...
            case 4:
                return ((MyDataNode) node).getCheck();
            default:
                break;
        }
        return null;
